...
namespace TraversalCoreProje
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseStaticFiles();
            app.UseAuthentication(); //Kimlik doðrulanmadan
            app.UseRouting();

            app.UseAuthorization(); //Yetkilendirme yapýlmaz bu yüzden Authentication iþlemi Authorization'dan önce yapýlýr.
